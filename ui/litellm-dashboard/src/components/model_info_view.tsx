  ...
  const handleModelUpdate = async (values: any) => {
    try {
      ...
      try {
        ...
        NotificationsManager.fromBackend("Invalid JSON in Params");
        setIsSaving(false);
        return;
      }
                  ...
                  <div className="space-y-4">
                    <div className="space-y-4">
                      ...
                      <div>
                        <Text className="font-medium">
                          Params
                          <Tooltip title="Optional params used for making a completion call. Some params are automatically added.">
                            <a
                              href="#"
                              target="_blank"
                              rel="noopener noreferrer"
