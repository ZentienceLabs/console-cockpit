...
model_access_policies = CopilotDB("model_access_policies")
feature_flag_policies = CopilotDB("feature_flag_policies")
connection_permission_policies = CopilotDB("connection_permission_policies")
